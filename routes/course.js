...
router.post("/", async (req, res) => {
    /*  #swagger.tags = ['Course']
        #swagger.description = 'Endpoint to create a course'
...
router.get("/", async (req, res) => {
    /*  #swagger.tags = ['Course']
        #swagger.description = 'Endpoint to get all courses'
        #swagger.security = [{
            "apiKeyAuth": []
        }]
    */
...
router.get("/:_id", async (req, res) => {
    /*  #swagger.tags = ['Course']
        #swagger.description = 'Endpoint to get course by id'
        #swagger.security = [{
            "apiKeyAuth": []
        }]
    */
...
router.patch("/:_id", async (req, res) => {
    /*  #swagger.tags = ['Course']
        #swagger.description = 'Endpoint to update course by id'
        #swagger.parameters['body'] = {
            in: 'body',
            description: 'Course data.',
            required: true,
...
router.delete("/:_id", async (req, res) => {
    /*  #swagger.tags = ['Course']
        #swagger.description = 'Endpoint to delete course by id'
        #swagger.security = [{
            "apiKeyAuth": []
        }]
    */
